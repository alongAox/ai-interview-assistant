...
export default function Home() {
  return (
    <div className="relative min-h-full flex-1 overflow-hidden bg-slate-50 dark:bg-slate-950">
      <div
        aria-hidden
      ...
      />
      <main className="relative mx-auto flex min-h-full max-w-5xl flex-col px-4 py-10 sm:px-6 sm:py-14">
        <InterviewAnalyzer />
      </main>
    </div>
  );
